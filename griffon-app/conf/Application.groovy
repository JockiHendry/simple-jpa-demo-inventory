...
mvcGroups {
    // MVC Group for "templateFaktur"
    'templateFaktur' {
        model      = 'project.main.TemplateFakturModel'
        view       = 'project.main.TemplateFakturView'
        controller = 'project.main.TemplateFakturController'
    }

    // MVC Group for "laporanDaftarInventory"
    'laporanDaftarInventory' {
        model      = 'project.laporan.LaporanDaftarInventoryModel'
        view       = 'project.laporan.LaporanDaftarInventoryView'
        controller = 'project.laporan.LaporanDaftarInventoryController'
    }

    // MVC Group for "laporanPenjualanEceran"
    'laporanPenjualanEceran' {
        model      = 'project.laporan.LaporanPenjualanEceranModel'
        view       = 'project.laporan.LaporanPenjualanEceranView'
        controller = 'project.laporan.LaporanPenjualanEceranController'
    }
    ...
    'laporanLabaRugi' {
        ...
        view       = 'project.labarugi.LaporanLabaRugiView'
        controller = 'project.labarugi.LaporanLabaRugiController'
    }
    ...
    'nilaiInventory' {
        ...
        view       = 'project.labarugi.NilaiInventoryView'
        controller = 'project.labarugi.NilaiInventoryController'
    }

    // MVC Group for "itemPenyesuaianAsChild"
    'itemPenyesuaianAsChild' {
        model      = 'project.inventory.ItemPenyesuaianAsChildModel'
        view       = 'project.inventory.ItemPenyesuaianAsChildView'
        controller = 'project.inventory.ItemPenyesuaianAsChildController'
    }

    // MVC Group for "laporanTransaksiKas"
    'laporanTransaksiKas' {
        model      = 'project.laporan.LaporanTransaksiKasModel'
        view       = 'project.laporan.LaporanTransaksiKasView'
        controller = 'project.laporan.LaporanTransaksiKasController'
    }

    // MVC Group for "jenisTransaksiKas"
    'jenisTransaksiKas' {
        model      = 'project.labarugi.JenisTransaksiKasModel'
        view       = 'project.labarugi.JenisTransaksiKasView'
        controller = 'project.labarugi.JenisTransaksiKasController'
    }

    // MVC Group for "transaksiKas"
    'transaksiKas' {
    ...
    'kategoriKas' {
        model      = 'project.labarugi.KategoriKasModel'
        view       = 'project.labarugi.KategoriKasView'
        controller = 'project.labarugi.KategoriKasController'
    }

    // MVC Group for "laporanSisaHutang"
    'laporanSisaHutang' {
        model      = 'project.laporan.LaporanSisaHutangModel'
        view       = 'project.laporan.LaporanSisaHutangView'
        controller = 'project.laporan.LaporanSisaHutangController'
    }

    // MVC Group for "produkQty"
    'produkQty' {
        model      = 'project.inventory.ProdukQtyModel'
        view       = 'project.inventory.ProdukQtyView'
        controller = 'project.inventory.ProdukQtyController'
    }

    // MVC Group for "laporanPenjualanTriwulan"
    'laporanPenjualanTriwulan' {
        model      = 'project.laporan.LaporanPenjualanTriwulanModel'
        view       = 'project.laporan.LaporanPenjualanTriwulanView'
        controller = 'project.laporan.LaporanPenjualanTriwulanController'
    }

    // MVC Group for "penerimaanServis"
    'penerimaanServis' {
        model      = 'project.servis.PenerimaanServisModel'
        view       = 'project.servis.PenerimaanServisView'
        controller = 'project.servis.PenerimaanServisController'
    }
    ...
    'laporanPembelianPerSupplier' {
        ...
        view       = 'project.laporan.LaporanPembelianPerSupplierView'
        controller = 'project.laporan.LaporanPembelianPerSupplierController'
    }

    // MVC Group for "laporanStokSupplier"
    'laporanStokSupplier' {
        model      = 'project.laporan.LaporanStokSupplierModel'
        view       = 'project.laporan.LaporanStokSupplierView'
        controller = 'project.laporan.LaporanStokSupplierController'
    }

    // MVC Group for "laporanPembayaranPiutang"
    'laporanPembayaranPiutang' {
        model      = 'project.laporan.LaporanPembayaranPiutangModel'
        view       = 'project.laporan.LaporanPembayaranPiutangView'
        controller = 'project.laporan.LaporanPembayaranPiutangController'
    }

    // MVC Group for "laporanReturProduk"
    'laporanReturProduk' {
        model      = 'project.laporan.LaporanReturProdukModel'
        view       = 'project.laporan.LaporanReturProdukView'
        controller = 'project.laporan.LaporanReturProdukController'
    }

    // MVC Group for "laporanReturJualPerKonsumen"
    'laporanReturJualPerKonsumen' {
        model      = 'project.laporan.LaporanReturJualPerKonsumenModel'
        view       = 'project.laporan.LaporanReturJualPerKonsumenView'
        controller = 'project.laporan.LaporanReturJualPerKonsumenController'
    }
