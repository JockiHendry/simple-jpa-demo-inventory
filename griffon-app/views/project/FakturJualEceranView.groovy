...
application(title: 'Faktur Jual Eceran',
    ...
    panel(id: 'mainPanel') {
        ...
        panel(constraints: PAGE_START) {
            ...
            textField(id: 'namaPembeliSearch', columns: 20, text: bind('namaPembeliSearch', target: model, mutual: true), actionPerformed: controller.search)
...
PromptSupport.setPrompt("Cari Nama Pembeli...", namaPembeliSearch)
