...
application(title: 'Satuan',
    ...
    panel(id: 'mainPanel') {
        ...
        panel(id: "form", layout: new MigLayout('', '[right][left][left,grow]', ''), constraints: PAGE_END, focusCycleRoot: true) {
            ...
            label('Singkatan:')
            textField(id: 'singkatan', columns: 10, text: bind('singkatan', target: model, mutual: true), errorPath: 'singkatan')
            errorLabel(path: 'singkatan', constraints: 'wrap')
