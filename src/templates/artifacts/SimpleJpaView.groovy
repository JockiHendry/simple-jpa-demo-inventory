...
application(title: '${natural(domainClass)}',
    ...
    panel(id: 'mainPanel') {
        ...
        panel(constraints: PAGE_START) {
            ...
            textField(id: '${firstField}Search', columns: 20, text: bind('${firstField}Search', target: model, mutual: true), actionPerformed: controller.search)
...
PromptSupport.setPrompt("Cari ${natural(firstField)}...", ${firstField}Search)