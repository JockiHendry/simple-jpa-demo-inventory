...
class FakturJualEceranMulai implements OperasiFakturJual {
    ...
    void hapus(FakturJual fakturJual) {
        throw new UnsupportedOperationException('Tidak ada operasi hapus untuk state FakturJualEceranMulai!')
    }

    @Override
    void tambahRetur(FakturJual fakturJual, ReturFaktur returFaktur) {
        throw new UnsupportedOperationException('Tidak ada operasi tambahRetur untuk state FakturJualEceranMulai!')
    }

    @Override
    void hapusRetur(FakturJual fakturJual, String nomor) {
        throw new UnsupportedOperationException('Tidak ada operasi hapusRetur untuk state FakturJualEceranMulai!')
    }
